...
function LogoutButton() {
  ...
  <div style={{
    ...
    borderRadius: '5px',
        ...
        {/* Company logo */}
        <img src="images\Frame 1000003850.png" alt="Company Logo" style={{ width: screenWidth < 900 ? '150px' : '100px' }} />
...
<div style={{ position: 'relative' }}>
  ...
  />
        ...
        {showMenu && <Menu handleMenuItemClick={handleMenuItemClick} style={{ position: 'absolute', zIndex: 2 }} />}
...
const RectanglesSection = () => {
  ...
  return (
    <div>
      ...
      {/* Media Query for screen width less than or equal to 1200px */}
      <style>
        {`
        @media (max-width: 1200px) {
          .rectangles-section-column {
            flex-direction: column;
            align-items: center;
          }
          .rectangles-section-column > div {
            width: 80%;
            margin: 10px 0;
          }
        }
...
export { Header, RectanglesSection };
